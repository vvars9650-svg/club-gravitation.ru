class FakeRepository:
    ...
    def save(self,key,record):
        ...
        self.by_key[key]=record;self.by_phone.setdefault(record['form']['phone'],record['participant_id']);self.participants.setdefault(record['participant_id'],{'phone':record['form']['phone'],'lifecycle_status':'new'});self.audit.append({'request_id':record['request_id'],'application_id':record['application_id'],'operation':'application_created','status':'ok'});return True
